...
public class FeedGroupController {
  ...
  public List<FeedGroupResponse> getAllGroup() {
    ...
    return groups.stream().map(mapperService::toFeedGroupResponse).collect(Collectors.toList());
  }
  ...
  public List<FeedResponse> getAllFeedInGroup(@PathVariable String groupKey)
    ...
    return feedService.getAllFeedInGroup(groupKey).stream()
        .map(mapperService::toFeedResponse)
  ...
  @PreAuthorize("hasAnyRole('EMPLOYEE')")
  void createNewIncubationSession(
      @PathVariable String groupKey, @RequestBody CreateIncubationSession body)
      throws CustomNotFoundException, CustomForbiddenException {
  ...
  void grantPermissionToUser(
      @PathVariable String groupKey, @RequestBody GrantPermissionToUserRequest body)
      throws CustomNotFoundException, CustomForbiddenException {
